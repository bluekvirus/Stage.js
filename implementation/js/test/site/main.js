                  ...
                  '<ul class="nav navbar-nav navbar-right">', //3
                    '<li class="dropdown">',
                        ...
                        '<ul class="dropdown-menu">',
                            ...
                            '<li><a href="#" action="download" target="stagejs-starter-kit.tar.gz"><i class="fa fa-arrow-circle-o-down"></i> stage.js (starter-kit)</a></li>',
                            '<li><a href="#" action="download" target="stagejs-edge.tar.gz"><i class="fa fa-arrow-circle-o-down"></i> stage.js (js only)</a></li>',
                            '<li class="divider"></li>',
