              ...
              '<ul class="nav navbar-nav">',//1
                ...
                '<li context="Demo" class="dropdown">',
                  ...
                  '<ul class="dropdown-menu">',
                    ...
                    '<li><a href="#navigate/Demo/Demo.RemoteTpl">Remote templating</a></li>',
                    '<li><a href="#navigate/Demo/Demo.WIP">Data handling</a></li>',
                    '<li><a href="#navigate/Demo/Demo.WIP">Coop events</a></li>',
                    '<li><a href="#navigate/Demo/Demo.Editors">Editors</a></li>',
                    '<li><a href="#navigate/Demo/Demo.WIP">Nesting with Regions</a></li>',
